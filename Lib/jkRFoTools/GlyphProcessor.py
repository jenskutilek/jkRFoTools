...
class myGlyphProcessorUI(GlyphProcessorUI):
    
    def _getExtensionID(self):
        # change this string, it will be used to store your settings
        return "de.kutilek.robofont.demoGlyphProcessor"
    
    def _buildUI(self):
        # build your window UI elements here and make sure to return the window at the end
        w = vanilla.FloatingWindow((200, 100), "Glyph Processor")
        return w
    
    def _initSettings(self):
        # settings will be saved automatically
        self.settings = {"mySetting": "myDefaultValue"}

#OpenWindow(myGlyphProcessorUI)
